# -*- coding: utf-8 -*-
"""
Generate affinity definitions for travel concepts using combined scoring (v33.0.26 - Tie-Breaking Sort).
...
Changes from v33.0.25:
- Added multi-key sorting in prepare_evidence to handle ties in combined_score.
- Prioritizes acsPCS, then acs, then core namespaces in case of ties.
...
SCRIPT_VERSION = "affinity-rule-engine-v33.0.26 (Tie-Breaking Sort)" # Updated version
...
# --- START: Updated Stage 1: Evidence Preparation (v33.0.26) ---
...
# --- END: Updated Stage 1: Evidence Preparation (v33.0.26) ---
...
def main():
    ...
    logger.info(f"SORTING: Tie-Breaking Enabled (Score > Namespace Prio > SBERT)") # Added log
