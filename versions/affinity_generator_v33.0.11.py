...
# --- <<< REVERTED FUNCTION (v33.0.11) >>> ---
def construct_llm_slotting_prompt(
    input_concept: str,
    theme_definitions: List[Dict[str, Any]],
    candidate_details: List[Dict[str, Any]],
    args: argparse.Namespace
    # Removed is_abstract_concept parameter
) -> Tuple[str, str]:
    """Constructs the main LLM prompt for theme slotting (v33.0.8/v33.0.11 version)."""
...
Do not include explanations or conversational text outside the JSON object."""
    ...
    # --- Standard Task Instruction (v33.0.8/v33.0.11) ---
